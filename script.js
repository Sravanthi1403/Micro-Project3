...
function getAllVegetablesDataViaFilter(){
    const newArr = foodOriginalData.filter(item => item.category === "Vegetable");
    console.log(newArr);
}

// 3. listing all the food items with category fruit

function getAllFruitsDataViaFilter(){
    const newArr = foodOriginalData.filter(item => item.category === "Fruit");
    console.log(newArr);
}

// 4. listing all the food items with category protien

function getAllProteinsDataViaFilter(){
    const newArr = foodOriginalData.filter(item => item.category === "Protein");
    console.log(newArr);
}

// 5. listing all the food items with category nuts
...
// 6. listing all the food items with category grains

function getAllGrainsDataViaFilter(){
    const newArr = foodOriginalData.filter(item => item.category === "Grain");
    console.log(newArr);
}

// 7. listing all the food items with category dairy
...
const foodOriginalData2 = foodOriginalData.slice();
foodOriginalData2.sort((a,b) => b.protiens - a.protiens);
console.log(foodOriginalData2);

// 11. listing all the food items with lowest cab content to highest

const foodOriginalData3 = foodOriginalData.slice();
foodOriginalData3.sort((a,b) => a.cab - b.cab);
console.log(foodOriginalData3);
